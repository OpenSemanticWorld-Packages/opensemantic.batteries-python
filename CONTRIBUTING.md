...
Welcome to `opensemantic.batteries` contributor's guide.
...
If you experience bugs or general issues with `opensemantic.batteries`, please have a look
...
You can help improve `opensemantic.batteries` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`opensemantic.batteries` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `opensemantic.batteries`'s files. While this mechanism can
...
```
conda create -n opensemantic.batteries python=3 six virtualenv pytest pytest-cov
conda activate opensemantic.batteries
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/opensemantic.batteries.git
   cd opensemantic.batteries
   ```
...
5. Install [pre-commit]:
   ...
   `opensemantic.batteries` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/opensemantic.batteries
[issue tracker]: https://github.com/<USERNAME>/opensemantic.batteries/issues
